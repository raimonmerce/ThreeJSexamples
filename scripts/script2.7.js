import * as THREE from 'https://cdn.skypack.dev/three@0.136.0/build/three.module.js';
    ...
    function main() {
        ...
        var wallBack = addObject(5, 5, 0, 0, 0, 0,
            new THREE.PlaneGeometry( 10, 10 ), 
            new THREE.MeshLambertMaterial({color: 0xffffff})
            );
        addWall(5, 5, -0.01, 0, -Math.PI / 2, 0, new THREE.Color( 0xffffff ));
        
        var wallRight = addObject(10, 5, 5, 0, -Math.PI / 2, 0,
            new THREE.PlaneGeometry( 10, 10 ), 
            new THREE.MeshLambertMaterial({color: 0xff0000})
            );
        addWall(10.01, 5, 5, 0, -Math.PI / 2, 0, new THREE.Color( 0xff0000 ));

        var wallLeft = addObject(0, 5, 5, 0, Math.PI / 2, 0,
            new THREE.PlaneGeometry( 10, 10 ), 
            new THREE.MeshLambertMaterial({color: 0x00ff00})
            );
        addWall(-0.01, 5, 5, 0, Math.PI / 2, 0, new THREE.Color( 0x00ff00 ));
        
        var wallTop = addObject(5, 10, 5, Math.PI/2, 0, 0,
            new THREE.PlaneGeometry( 10, 10 ), 
            new THREE.MeshLambertMaterial({color: 0xffffff})
            );

        var wallBottom = addObject(5, 0, 5, -Math.PI/2, 0, 0,
            new THREE.PlaneGeometry( 10, 10 ), 
            new THREE.MeshLambertMaterial({color: 0xffffff})
            );
        
        var wallLight = addObject(5, 9.99, 5, Math.PI/2, 0, 0,
